            ...
            <div class="col-sm-12 col-md-12">
                <div class="page-title">
                    <div class="title-left">
                        <h3>공지사항 등록
                            <small>서비스 관리 / <a href="/service/notices">공지사항 관리</a> / <b><a href="/service/notice">공지사항 등록</a></b></small>
                        </h3>
                    </div>
                            ...
                            <tr>
                                ...
                                <td colspan="3" class="input-parsley">
                                    <input type="text" id="createSubject" class="form-control" maxlength="256"
                                           data-parsley-required="true" placeholder="공지사항 제목" autocomplete="off">
                                </td>
                            </tr>
                            <tr>
                                <th>내용</th>
