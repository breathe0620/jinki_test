    ...
    <jsp:body>
            ...
            <div class="col-sm-12 col-md-12">
                <div class="page-title">
                    <div class="title-left">
                        <h3>FAQ 관리
                            <small>서비스 관리 / <b><a href="/service/faqs">FAQ 관리</a></b></small>
                        </h3>
                    </div>
        ...
        <div class="row">
            <div class="col-sm-12 col-md-12">
                <div class="box">
                    <div class="box-title">
                        <h5><i class="fa fa-search"></i>FAQ 리스트 조회</h5>
                        <div class="box-tools">
                    ...
                    <div class="box-content">
                        ...
                        <div class="col-sm-4 col-md-3">
                            <select name="selectType">
                                ...
                                <option value="19" selected>FAQ 제목</option>
                                <option value="20">FAQ 내용</option>
                            </select>
                        </div>
                            ...
                            <tr name="list">
                                ...
                                <td>
                                    <c:choose>
                                        ...
                                        <c:when test="${item.category == '02'}">
                                            <label class="label label-success">플레이어</label>
                                        </c:when>
                                        <c:when test="${item.category == '03'}">
                                            <label class="label label-primary">이용안내</label>
                                        </c:when>
                                        <c:when test="${item.category == '04'}">
                                ...
                                <td name="faqSubjectEn">${fn:escapeXml(item.subjectEn)}</td>
                                <td name="faqSubject">${fn:escapeXml(item.subject)}</td>
        ...
        <form action="/service/faqs" method="get" id="paginationForm">
