    ...
    <jsp:body>
            ...
            <div class="col-sm-12 col-md-12">
                <div class="page-title">
                    <div class="title-left">
                        <h3>앨범 메타 관리
                            <small>메타 관리 / <b><a href="/meta/album">앨범 메타 관리</a></b></small>
                        </h3>
                    </div>
        ...
        <div class="row">
            <div class="col-sm-12 col-md-12">
                <div class="box">
                    <div class="box-title">
                        <h5><i class="fa fa-search"></i>앨범 리스트 조회</h5>
                        <div class="box-tools">
                        ...
                        <div class="col-sm-12 col-md-7">
                            ...
                            <div class="col-sm-4 col-md-3">
                                <select name="selectType">
                                    ...
                                    <option value="12" selected>앨범명</option>
                                    <option value="11">아티스트명</option>
                                    <option value="1">앨범MID</option>
                                </select>
                            </div>
            ...
            <div class="col-sm-12 col-md-12">
                <div class="table-responsive">
                    ...
                    <table class="table table-striped table-list table-custom">
                        ...
                        <tr>
                            <th width="8%">앨범ID</th>
                            <th width="10%">앨범MID</th>
                            <th width="50%">앨범명</th>
                            <%--<th width="26%">앨범명 <span class="red">(영문)</span></th>--%>
                            <th width="15%">아티스트명</th>
                            <th width="15%">발매일</th>
                        </tr>
                        </thead>
                        ...
                        <c:forEach var="item" items="${result.pageResult.content}" varStatus="status">
                            <tr name="list">
                                <td name="albumId">${item.albumId}</td>
                                <td>${item.originId}</td>
                                <td>${fn:escapeXml(item.albumTitle)}</td>
                                <%--<td>${fn:escapeXml(item.albumTitleEN)}</td>--%>
                                <td>
        ...
        <form action="/meta/album" method="get" id="paginationForm">
